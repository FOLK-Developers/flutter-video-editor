        ...
        child: ListView(
          children: [
                ...
                child: Material(
                  ...
                  child: InkWell(
                    ...
                    child: Column(
                      mainAxisAlignment: MainAxisAlignment.center,
                      children: <Widget>[
                        Icon(Icons.shutter_speed, size: 20), // icon
                        Text("Speed"), // text
                      ],
                    ),
                  ),
                ...
                child: Material(
                  ...
                  child: InkWell(
                    ...
                    onTap: () async {
                      ...
                      if (f3 != null) {
                        final File t3 = await Navigator.of(context)
                          ...
                          // return PickAudio(video.last);
                          return Audiox(video.last);
                        }));
                        setState(() {
                          if (t3 != null) {
                            video.add(t3);
                    ...
                    child: Column(
                      mainAxisAlignment: MainAxisAlignment.center,
                      children: <Widget>[
                        Icon(Icons.music_note, size: 20), // icon
                        Text("Music"), // text
                      ],
                    ),
                  ),
            ...
            SizedBox.fromSize(
              ...
              child: ClipOval(
                child: Material(
                  color: Color(0xff2b4570), // button color 0xff2b4570
                  child: InkWell(
                    splashColor: Colors.green, // splash color
                    onTap: () async {
                      File f3 = video.last;
